...
- New line character are assumed as line terminators
- '?' character signifies the end of question
- Inputs are case sensitive
- Empty inputs are considered as invalid inputs
- Roman numbers are always in Capitals
